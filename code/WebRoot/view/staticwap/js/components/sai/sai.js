define("components/sai/sai", ["components/sai/spm/web-detector","components/sai/spm/evt","components/log/log"], function(require, exports, module){
  var win = window;
  var doc = win.document;
  var loc = win.location;
  var M = win.Sai;

  var detector = require("components/sai/spm/web-detector");
  var Events = require("components/sai/spm/evt");
  var log = require("components/log/log");
  ...
  var URLLength = (detector.engine === 'undefined') ? 2083 : 8190;
  ...
  function send(data, callback){
    ...
    /*var d = param(data);*/
    /*
    * DataInterface Object通过count.js的的全局变量获取
    * */
    if(typeof(DataInterface) != "undefined") {
      var url = DataInterface.getRequestUrl(data);
      // 忽略超长 url 请求，避免资源异常。
