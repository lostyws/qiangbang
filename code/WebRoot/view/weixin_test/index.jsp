...
<head>
  ...
  <link rel="stylesheet" href="/view/weixin_test/css/style.css">
</head>
<body ontouchstart="">
...
<script>
  ...
  wx.config({
      debug: true,
      appId: 'wxb3d0024cd88f6734',
      timestamp: 1464248209,
      nonceStr: 'Ws3WZYTPz0wzccnW',
      signature: '17237f3b318532b951b95ff4bab93636d4895818',
      jsApiList: [
        'checkJsApi',
        'onMenuShareTimeline',
...
<script src="/view/weixin_test/js/zepto.min.js"></script>
<script src="/view/weixin_test/js/demo.js"> </script>
</html>