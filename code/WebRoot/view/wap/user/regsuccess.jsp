      ...
      <div class="view view-main">
       <div class="navbar navbar-white">
				<div class="navbar-inner">
					...
					<div class="center sliding">注册成功</div>
					<div class="right">
          ...
          <div data-page="home" class="page navbar-fixed">
          	<div class="page-content">
				<div class="content-block">
                    <p>恭喜您成功提交资料！工作人员在1·2工作日审核资料。未审核通过之前除不可以抢单报价外其他功能都能正常使用</p>
                </div>

		        <div class="content-block">
		          <a href="javascript::void(0);" onclick="javascript:window.location.href='/wapact/index'" class="external button button-fill button-big form-to-json">确定</a>
		        </div>
          	</div>
          </div>
        </div>
