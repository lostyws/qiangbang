		              ...
		              <div class="item-content">
		                <div class="item-inner">
		                  ...
		                  <div class="item-input">
		                    <textarea class="describe-text" maxlength="100" placeholder="请输入简单的描述让客户更加了解您的店铺">${business.shopcontent }</textarea>
		                  </div>
		                </div>
		              </div>
		            </li>
...
<script type="text/javascript" src="/view/staticwap/framework7/js/my-app.js"></script>
        ...
        function dataAjax(shopname) {
        	...
        	$$.ajax({
        		url: "/wapact/updateDescription",
        		type: "post",
        		dataType: "json",
        		data: {
        			describeText:shopname,
        			type:type
        		},
        		success: function(d){
        			//hide loading...
