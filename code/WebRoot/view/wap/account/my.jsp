                    ...
                    <div class="user-info-wrapper">
                        <div class="user-info">
								<a href="/wapact/goAccountSet" class="external need-login">
									<div>
										<c:choose>
				                    		<c:when test="${not empty sessionScope.users.personpath}">
							                    <img class="user-face" src="${sessionScope.users.personpath }">
										 	</c:when>
										 	<c:otherwise>
												<img class="user-face"
                        ...
                        <div class="row">
                            <div class="col-50">
                                <a href="/wapact/goMybalance" class="external need-login">
                                    余额<div><span class="balance-fee">${users.price }</span>元</div>
                                </a>
                            </div>
                            <div class="col-50">
                                <a href="/view/wap/user/message.jsp" class="external need-login">
                                    未读消息<div><span class="voucher-num" style="color: red;">${res.msgCount }</span>条</div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="my-insured-wrapper">
                            ...
                            <div class="my-insured-detail my-oder-warp" style="display:none">
                                <div class="buttons-row">
							      ...
							      <a href="#tab4" type-value='4' class="tab-link button ">待支付</a>
							      <a href="#tab1" type-value='1' class="tab-link button">进行中</a>
							     <!--  <a href="#tab5" type-value='5' class="tab-link button " >待确认</a> -->
							  ...
							  <div class="tabs">
								...
								<div id="tab5" class="tab content-block infinite-scroll">
									<div class="list-block"></div>		
									<!-- 加载提示符 -->
									  <div class="infinite-scroll-preloader">
									    <div class="preloader"></div>
