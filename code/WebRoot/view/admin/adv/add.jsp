				...
				<div class="panel-body">
					<div class="form-horizontal">
						<div class="form-group">
							...
							<div class="col-md-2"><input class="form-control" name="title" type="text" datatype="*1-50" errormsg="广告标题允许1-20位的英文、数字、汉字" nullmsg="请输入广告标题" maxlength="50"></div>
                        ...
                        <div class="form-group">
							...
							<div class="col-md-6"><input class="form-control" name="adv_url" type="text" datatype="*0-1000" nullmsg="请输入完整的url地址(含:http://)"></div>
							<div class="col-md-2"><p class="help-block" id="adv_url_msg">请输入完整的URL链接地址</p></div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
		                         		<input name="content" type="hidden" id="img_upload" value="">
...
<script src="/view/static/admin/js/adv/add.js"></script>
