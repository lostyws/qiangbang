...
<body>
                    		...
                    		<form action="/category/save" theme="simple" method="post" id="form" name="form">
								...
								<table class="table table-bordered" style="width: 95%;margin: auto;">
									...
									<tr>
										...
										<td style="text-align: left;"><input type="text" name="category.categoryname"  id="price" size="20" maxlength="20"/></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td style="text-align: left;"><input type="text"  name="category.corder"  id="price" size="20" maxlength="20"
												/></td>
									</tr>
									<tr>
									...
									<tr>
										<td colspan="2" style="text-align: center;">
						                        <button id="submitCateAdd" type="button" class="btn btn-success"><i class="icon-ok icon-white"></i> 新增</button>
    ...
    <script src="/view/static/admin/js/classifymanagement/add.js"></script>
