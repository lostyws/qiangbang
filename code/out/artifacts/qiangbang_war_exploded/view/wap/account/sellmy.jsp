                ...
                <div class="page-content">
                        ...
                        <div class="user-info">
								<a href="/wapact/goAccountSet" class="external need-login">
									<div>
										...
										<div>
											<span class="user-name">${sessionScope.users.username }</span>
										</div>
									</div>
                    ...
                    <div class="my-insured">
                        <div class="row">
                            ...
                            <div class="col-50">
                                <a href="javascript:void(0);" class="external need-login">
									...
									<div class="row">
										<div class="col-25">
											<a href="javascript:void(0);"
												class="link need-login js-select-type" type-value="4"><div>
													<span class="orders-num">${res.nopay }</span>单
												</div>
												<div>待支付</div></a>
										</div>
										<div class="col-25">
											<a href="javascript:void(0);" class="link need-login js-select-type" type-value="7"><div>
													<span class="renew-num">${noComprcount }</span>单
												</div>
												<div>待选标</div></a>
										</div>
										<div class="col-25">
											<a href="javascript:void(0);" class="link need-login js-select-type" type-value="5"><div>
													<span class="renew-num">${res.noconfirm }</span>单
												</div>
												<div>待确认</div></a>
										</div>
										
										<div class="col-25">
											<a href="/view/wap/user/message.jsp" class="external need-login"><div>
													<span class="message-num">${res.msgCount }</span>条
												</div>
												<div>未读信息</div></a>
										</div>
									</div>
                    ...
                    <div class="list-block">
                        <ul>
                            ...
                            <li>
                                <a href="/shop/index" class="item-link item-content need-login external">
...
<script type="text/template7" id="orderInfo">
        {{#each this}}
        <button class="external order-item" data-url="/waptask/detail/{{taskId}}">
            ...
            <div class="order-info">
                ...
                <span>
					...
					<a class="color-red amount" href="www.baidu.com">去支付</a>
