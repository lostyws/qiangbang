...
<body class=mobile-page>
            ...
            <ul>
                <li data-dstate="bid_node" class="active ">
                    <div class="underline item">
                        ...
                        <div class="body">
                            <div class="time">2016-05-20 11:26:46</div>
                            <div class="desc">服务商报名参与了您的需求</div>
                            <p>报价：<span class="fcolor-orange">&yen;122.00</span></p>
                            <div class="desc">描述：服务商报名参与了您的需求服务商报名参与了您的需求服务商报名参与了您的需求</div>
                        </div>
                    </div>
                    <div class="none"></div>
                </li>
                ...
                <li data-dstate="agreement_node" class="active">
                    <div class="underline item">
                        ...
                        <div class="body">
                            ...
                            <div class="buttons">	
                                <button class="select exchange">
                                    选TA,签单
                                </button>
                                <button class="agreement-remind b-orange">
                                    提醒服务商发起
                                </button>
                            </div>
                        </div>
                ...
                <li data-dstate="connection_node" class="current">
                    <div class="underline item">
                        ...
                        <div class="body">
                            <div class="time">2016-05-20 11:27:01</div>
                            <p>评分：4.6</p>
                            <div class="desc">评价内容：12334455</div>
                        </div>
                    </div>
                    <div class="none"></div>
                </li>
    ...
    <script id="download-app" type="tpl">
        <div class="confirm-con download-app">
            ...
            <div class="confirm-bottom display-box">
                <a href="http://m.zbj.com/qrcode/scan/app" class="download">立即下载</a>
            </div>
        </div>
    </script>
