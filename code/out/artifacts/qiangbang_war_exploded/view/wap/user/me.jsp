        ...
        <div class="person-message">
            ...
            <div class="bottom">
                <ul class="unstyled display-flex">
                    <li class="item non">
                        <span class="identify-name"></span>未认证
                    </li>
                    <li class="vertival-middle"></li>
                    <li class="item">
                        <span class="identify-mobile"></span>已手机认证
                    </li>
                </ul>
            </div>
        </div>
    ...
    <script type="text/template" id="order-tpl">
				...
				<button class="order-item click" data-url="/task/${item.taskId}/">
						<div class="order-status  type${item.state}">
							...
							{@if item.taskType == '1'}
							<span class="order-resource">天蓬</span>
							{@/if}
							{@if item.state==1 && item.amount!=0}
							<input type="button" class="tuoguan-reward" data-taskid="${item.taskId}" data-linkid="10006664" value="托管">
							{@/if}
						</div>
