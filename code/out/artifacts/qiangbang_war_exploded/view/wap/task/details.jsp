        ...
        <div class="item item-3"><span></span>招标</div>
            ...
            <div class="clearfix with-padding-lr buyer">
                <div class="pull-l help-button">
                    ...
                    <button class="power js-evaluate" data-herf="/waptask/goCloseTask?taskId=${task.id }"><i class="iconfont icon-power"></i>关闭需求</button>
                </div>
            </div>
            <!-- /顾问协作-->
