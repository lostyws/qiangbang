...
<body class=mobile-page>
    ...
    <div class="page-container bg-grey zhaobiao-page">
        ...
        <div class="need-detail-top border-bottom-o">
            ...
            <div class="clearfix">
                <div class="inner pull-l">状态：待托管赏金</div>
                <div class="inner pull-r">订单编号：7478983</div>
            </div>
        </h3>
            </div>
        </div>
        <div class="need-detail-content border-top bg-white margin-b-15">
            <div class="with-padding border-bottom">
                ...
                <div class="price fsize-20 fcolor-orange">
                    500.0
                    <span class="fsize-12">元</span>
                </div>
                <div class="summary">
                    <div class="content-slidedown-con">
                        做一个好看的首页，主要是设计，看起来美观即可 设计时间：两周 预算：500，可谈
        ...
        <div class="item item-3"><span></span>招标</div>
            ...
            <div class="clearfix with-padding-lr buyer">
                <div class="pull-l help-button">
                    ...
                    <button class="tuoguan-reward js-evaluate" data-herf="view/wap/evaluate/toseller.jsp?id=111"><i class="iconfont icon-tuoguan-reward"></i>评价</button>
            ...
            <script id="contact-adviser" type="tpl">
                <div class="confirm-con contact-adviser">
                    ...
                    <div class="confirm-bottom display-box">
                        <button class="sure only-one item">拨打1222222334热线</button>
                    </div>
                </div>
            </script>
            <!-- /关闭需求-->
        ...
        <div class="provider-list bg-white border-top">
         ...
         <!--/ 已公开的案例 -->
                                 ...
                                 <div class="item">
                <div class="top with-padding" onclick="javascript:location.href='/shop/10834373/'">
                    <div class="img pull-l"><img src="http://avatar.zbjimg.com/010/83/43/200x200_avatar_73.jpg!small" alt=""></div>
                    <div class="text">
                        <p class="name">易商务网络科技</p>
                        <p>
                        ...
                        <p class="edit pull-r">
                            <a href="#" data-phone="18738524274" class="contact make-a-call btn-press-down"></a>
                        </p>
                    </div>
                </div>


                                <div class="bottom" onclick="javascript:location.href='/view/wap/bid/workBench.jsp?taskId=7564169&amp;workId=86199987&amp;salerId=10834373'">
                    <div class="detail-button">
                        <p class="fsize-14 with-padding">报价：<span class="fcolor-orange">&yen;122.00</span></p>
                        ...
                        <div class="item">
                <div class="top with-padding" onclick="javascript:location.href='/shop/14346633/'">
                    <div class="img pull-l"><img src="http://avatar.zbjimg.com/014/34/66/200x200_avatar_33.jpg!small" alt=""></div>
                    <div class="text">
                        <p class="name">dsdrrt</p>
                        <p>
                        <span class="provider-grade provider-grade-1">未认证</span>
                        <span class="provider-grade provider-grade-2">已认证</span>
                        <span class="provider-grade provider-grade-3">已交保证金</span>
                        ...
                        <p class="edit pull-r">
                            <a href="#" data-phone="" class="contact make-a-call btn-press-down"></a>
                        </p>
                    </div>
                </div>


                                <div class="bottom" onclick="javascript:location.href='/view/wap/bid/workBench.jsp?taskId=7564169&amp;workId=86200011&amp;salerId=14346633'">
                    <div class="detail-button">
                        <p class="fsize-14 with-padding">报价：<span class="fcolor-orange">&yen;122.00</span></p>
                        <p class="arrow-right"></p>
                    </div>
                        ...
                        <div class="item">
                <div class="top with-padding" onclick="javascript:location.href='/shop/15000946/'">
                    <div class="img pull-l"><img src="http://avatar.zbjimg.com/015/00/09/200x200_avatar_46.jpg!small" alt=""></div>
                    <div class="text">
                        <p class="name">千店电商系统</p>
                        <p><span class="provider-grade provider-grade-1">未认证</span></p>
                        <p class="edit pull-r">
                            <a href="#" data-phone="" class="contact make-a-call btn-press-down"></a>
                        </p>
                    </div>
                                ...
                                <div class="bottom" onclick="javascript:location.href='/view/wap/bid/workBench.jsp?taskId=7564169&amp;workId=86200417&amp;salerId=15000946'">
                    <div class="detail-button">
                        <p class="fsize-14 with-padding">报价：<span class="fcolor-orange">&yen;122.00</span></p>
                        <p class="arrow-right"></p>
                    </div>
        ...
        <div class="fixed-bottom order-entrust">
            ...
            <a class="flex-right js-competitive" href="/view/wap/task/competitive.jsp" data-linkid="10006666">竞标</a>
        ...
        <script id="download-app" type="tpl">
            <div class="confirm-con download-app">
                ...
                <div class="confirm-body bg-whiteradius-top">
                    <p class='align-c'>功能正在开发，请移步APP
                        <br/>现在下载，随时随地管理您的订单</p>
                </div>
        ...
        <div class="adviser-cooperate-container-fixed">
            <div class="adviser-cooperate">
                <div class="img">
                    <img src="/view/staticwap/image/page/need-detail/adviser-avatar.png" alt="">
                </div>
                <div class="text">联系
                    <br />交易顾问</div>
            </div>
