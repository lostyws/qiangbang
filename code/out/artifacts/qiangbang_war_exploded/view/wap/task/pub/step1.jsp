...
<body class=mobile-page>
    ...
    <div class="top-bar-help-btn as-extend">
        <a href="/user/tohelp" data-linkid="10006697">帮助</a>
    </div>
                ...
                <div class="buy-service-container bg-grey">
                    <div class="buy-service-form bg-white">
                        ...
                        <div class="control-group control-textarea with-padding-lr bg-white">
                            <div class="control-group-title">您想要做</div>
            ...
            <div class="bottom-button bg-white fcolor-orange border-top">
                <div class="display-box ">
                    <div class="price-item">
                        <div class="inner-con">
                            <span>¥</span>
                            <input type="number" id="priceNum" maxlength="8" name="amount" class="need-must" value="" placeholder="待商议" tabindex="6" data-linkid="10006720" />
                        </div>
                    </div>
                    <div class="button-item">
                        <button class="bg-orange btn-press-down disabled" id="btnFav" type="button" data-linkid="10006721">提交</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    <div id="dialog-trust" class="home-pub-dialog-con">
        <div class="home-trust-dialog">
            ...
            <div class="home-trust-dialog-ft">
                <a class="btn-trust downApp" href="http://m.zbj.com/qrcode/scan/app">托管赏金</a>
            </div>
        </div>
    </div>
