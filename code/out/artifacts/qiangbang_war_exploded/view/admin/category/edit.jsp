...
<body>
								...
								<table class="table table-bordered" style="width: 95%;margin: auto;">
									...
									<tr>
										<td colspan="2" style="text-align: center;">
						                        <button onclick="submitAddCate();" type="button" class="btn btn-success"><i class="icon-ok icon-white"></i> 保存</button>
    ...
    <script src="${domain}/view/static/plugins/jquery-treegrid/js/jquery.treegrid.js"></script>
    <script src="${domain}/view/static/plugins/handlebars/handlebars.min.js"></script>
    <script src="${domain}/view/static/plugins/datatables/js/dataTables.bootstrap.min.js"></script>
    <script src="${domain}/view/static/plugins/datatables/js/jquery.datatables.js"></script>
    <!-- 弹框模板 -->
